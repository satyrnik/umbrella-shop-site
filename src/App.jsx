      ...
      <section id="hero" className="hero">
        <div className="hero-content">
          <div className="hero-text">
            <h1>LAB-GRADE POWER</h1>
            <p>
              Премиальные спортивные добавки для тех, кто относится к телу
              как к боевой системе. Лабораторный контроль, сильный визуал,
              честный результат.
            </p>
          ...
          <div className="hero-placeholder">
            {/* Заглушка под будущую картинку */}
            <span>Тут будет главный визуал:</span>
            <span>атлет + силуэты + лаборатория</span>
          </div>
        </div>
      </section>
